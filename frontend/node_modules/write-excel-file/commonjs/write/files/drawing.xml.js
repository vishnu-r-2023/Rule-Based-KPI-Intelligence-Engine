...
exports["default"] = generateDrawingXml;
...
function generateDrawingXml(_ref) {
  ...
  var _loop = function _loop() {
    ...
    output += '<xdr:pic>';
    output += '<xdr:nvPicPr>';
    output += "<xdr:cNvPr id=\"".concat(imageId, "\" name=\"").concat(image.title ? (0, _sanitizeAttributeValue["default"])(image.title) : 'Picture ' + imageId, "\" descr=\"").concat(image.description ? (0, _sanitizeAttributeValue["default"])(image.description) : '', "\"/>");
    output += '<xdr:cNvPicPr>';
