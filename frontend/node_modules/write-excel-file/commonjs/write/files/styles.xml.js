...
function generateStylesXml(_ref) {
  ...
  if (formats.length > 0) {
    ...
    for (var i = 0; i < formats.length; i++) {
      xml += "<numFmt numFmtId=\"".concat(_styles.FORMAT_ID_STARTS_FROM + i, "\" formatCode=\"").concat((0, _sanitizeAttributeValue["default"])(formats[i]), "\"/>");
    }
    xml += "</numFmts>";
  }
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(fonts), _step; !(_step = _iterator()).done;) {
    ...
    xml += "<name val=\"".concat((0, _sanitizeAttributeValue["default"])(family), "\"/>");
  ...
  for (var _iterator2 = _createForOfIteratorHelperLoose(fills), _step2; !(_step2 = _iterator2()).done;) {
    ...
    if (_color) {
      ...
      xml += "<fgColor rgb=\"".concat((0, _sanitizeAttributeValue["default"])(getColor(_color)), "\"/>");
