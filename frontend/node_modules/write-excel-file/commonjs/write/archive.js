...
var Archive = exports["default"] = /*#__PURE__*/function () {
  function Archive(outputPath) {
    ...
    this.promise = new Promise(function (resolve, reject) {
      ...
      _this.outputStream.on('close', function () {
        resolve({
      ...
      archive.pipe(_this.outputStream);
    });
  }
